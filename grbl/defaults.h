...
#ifdef DEFAULTS_EW
  #define MICROSTEPS_X 8  // Adjustable by means of DIP switches on driver
  #define STEP_PER_REV_X 200  // Steps per motor rev
  #define BELT_LEAD_X 3.0   // 3.0mm belt pitch
  #define PULLEY_TEETH_X 24   // 24 teeth per motor rev
  #define MM_PER_REV_X (BELT_LEAD_X*PULLEY_TEETH_X)
  #define MICROSTEPS_Y 8  // Adjustable by means of DIP switches on driver
  #define STEP_PER_REV_Y 200  // Steps per motor rev
  #define BELT_LEAD_Y 3.0   // 3.0mm belt pitch
  #define PULLEY_TEETH_Y 24   // 24 teeth per motor rev
  #define MM_PER_REV_Y (BELT_LEAD_Y*PULLEY_TEETH_Y)
  #define MICROSTEPS_Z 8  // Adjustable by means of DIP switches on driver
  #define STEP_PER_REV_Z 200  // Steps per motor rev
  #define BELT_LEAD_Z 3.0   // 3.0mm belt pitch
  #define PULLEY_TEETH_Z 24   // 24 teeth per motor rev
  #define MM_PER_REV_Z (BELT_LEAD_Z*PULLEY_TEETH_Z)
  #define DEFAULT_X_STEPS_PER_MM (MICROSTEPS_X*STEP_PER_REV_X/MM_PER_REV_X)
  #define DEFAULT_Y_STEPS_PER_MM (MICROSTEPS_Y*STEP_PER_REV_Y/MM_PER_REV_Y)
  #define DEFAULT_Z_STEPS_PER_MM (MICROSTEPS_Z*STEP_PER_REV_Z/MM_PER_REV_Z)
